...
var renderWeb3Hook = function (hook, options) { return __awaiter(void 0, void 0, void 0, function () {
    var providers, multicallAddresses, defaultProvider, addSingleProvider, providerObject, _a, _b, _i, chainIdString, chainId, UserWrapper, _c, result, waitForNextUpdate, rerender, unmount;
    var _d, _e, _f;
    return __generator(this, function (_g) {
        switch (_g.label) {
            case 0:
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, (0, utils_1.deployMulticall)(currentProvider, chainId)];
                            case 2:
                                mockMulticallAddresses = _c.sent();
                ...
                providerObject = (options === null || options === void 0 ? void 0 : options.mockProvider) || new provider_1.MockProvider();
                if (!(providerObject instanceof provider_1.MockProvider)) return [3 /*break*/, 2];
                defaultProvider = providerObject;
                return [4 /*yield*/, addSingleProvider(providerObject)];
            case 1:
                _g.sent();
                return [3 /*break*/, 6];
            case 2:
                _a = [];
                for (_b in providerObject)
                    _a.push(_b);
                _i = 0;
                _g.label = 3;
            case 3:
                ...
                return [4 /*yield*/, addSingleProvider(providerObject[chainId])];
            case 4:
                _g.sent();
                _g.label = 5;
            case 5:
            ...
            case 6:
                ...
                _c = (0, react_hooks_1.renderHook)(hook, {
                    wrapper: function (wrapperProps) { return ((0, jsx_runtime_1.jsx)(providers_1.NetworkProvider, __assign({ providerOverride: defaultProvider }, { children: (0, jsx_runtime_1.jsx)(network_1.ReadonlyNetworksProvider, __assign({ providerOverrides: providers }, { children: (0, jsx_runtime_1.jsx)(providers_1.BlockNumberProvider, { children: (0, jsx_runtime_1.jsx)(blockNumbers_1.BlockNumbersProvider, { children: (0, jsx_runtime_1.jsx)(providers_1.MultiChainStateProvider, __assign({ multicallAddresses: multicallAddresses }, { children: (0, jsx_runtime_1.jsx)(UserWrapper, __assign({}, wrapperProps)) })) }) }) })) }))); },
                ...
                return [2 /*return*/, __assign({ result: result, defaultProvider: defaultProvider, mineBlock: function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/, (0, utils_1.mineBlock)(defaultProvider)];
