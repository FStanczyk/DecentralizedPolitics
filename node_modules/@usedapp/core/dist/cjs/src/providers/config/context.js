...
function useConfig() {
    var _a;
    var config = (0, react_1.useContext)(exports.ConfigContext).config;
    // backward compatible with supportedChains
    if (config.supportedChains) {
        console.warn('supportedChain is deprecated, please pass networks instead');
        var networks = (_a = config.supportedChains) === null || _a === void 0 ? void 0 : _a.map(function (chainId) { return (0, chain_1.getChainById)(chainId); });
...
function useUpdateConfig() {
    var updateConfig = (0, react_1.useContext)(exports.ConfigContext).updateConfig;
    return updateConfig;
}
