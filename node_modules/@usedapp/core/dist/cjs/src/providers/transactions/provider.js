...
function TransactionProvider(_a) {
    ...
    var _b = (0, hooks_1.useEthers)(), chainId = _b.chainId, library = _b.library;
    var blockNumber = (0, blockNumber_1.useBlockNumber)();
    var localStorage = (0, config_1.useConfig)().localStorage;
    var _c = (0, hooks_1.useLocalStorage)(localStorage.transactionPath), storage = _c[0], setStorage = _c[1];
    var _d = (0, react_1.useReducer)(reducer_1.transactionReducer, storage !== null && storage !== void 0 ? storage : model_1.DEFAULT_STORED_TRANSACTIONS), transactions = _d[0], dispatch = _d[1];
    var addNotification = (0, context_1.useNotificationsContext)().addNotification;
    (0, react_1.useEffect)(function () {
        setStorage(transactions);
    }, [transactions]);
    var addTransaction = (0, react_1.useCallback)(function (payload) {
        dispatch({
                        ...
                        checkTransaction = function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 3:
                                        error_1 = _a.sent();
                                        console.error("failed to check transaction hash: ".concat(tx.transaction.hash), error_1);
                                        return [3 /*break*/, 4];
    ...
    return (0, jsx_runtime_1.jsx)(context_2.TransactionsContext.Provider, { value: { transactions: transactions, addTransaction: addTransaction }, children: children });
}
