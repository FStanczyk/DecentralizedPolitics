...
describe('Multicall', function () {
    ...
    it('Retrieves token balance using aggregate', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    data = new abi_1.Interface(__1.ERC20Mock.abi).encodeFunctionData('balanceOf', [deployer.address]);
                    call = {
                ...
                case 1:
                    blockNumber = _a.sent();
                    return [4 /*yield*/, (0, __1.multicall)(mockProvider, multicallContract.address, blockNumber, [call])];
                case 2:
                    result = _a.sent();
                    unwrappedResult = result[tokenContract.address][data];
                    (0, chai_1.expect)(bignumber_1.BigNumber.from(unwrappedResult === null || unwrappedResult === void 0 ? void 0 : unwrappedResult.value)).to.eq('10000');
                    return [2 /*return*/];
            }
        });
    }); });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, chai_1.expect)((0, __1.multicall)(mockProvider, multicallContract.address, blockNumber, [call])).to.be.eventually.rejected];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all([
                            (0, __1.multicall)(mockProvider, multicallContract.address, blockNumber, [call]),
                            (0, __1.multicall)(mockProvider, multicallContract.address, blockNumber, [call]),
                            (0, __1.multicall)(mockProvider, multicallContract.address, blockNumber, [call]),
                            (0, __1.multicall)(mockProvider, multicallContract.address, blockNumber, [call]),
                            (0, __1.multicall)(mockProvider, multicallContract.address, blockNumber, [call]),
