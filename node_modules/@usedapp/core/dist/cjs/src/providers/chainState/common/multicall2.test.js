...
describe('Multicall2', function () {
    ...
    it('Retrieves token balance using tryAggregate', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    data = new abi_1.Interface(constants_1.ERC20Mock.abi).encodeFunctionData('balanceOf', [deployer.address]);
                    call = {
                ...
                case 1:
                    blockNumber = _b.sent();
                    return [4 /*yield*/, (0, multicall2_1.multicall2)(mockProvider, multicallContract.address, blockNumber, [call])];
                case 2:
                    result = _b.sent();
                    _a = result[tokenContract.address][data] || {}, value = _a.value, success = _a.success;
                    (0, chai_1.expect)(success).to.be["true"];
                    (0, chai_1.expect)(bignumber_1.BigNumber.from(value)).to.eq('10000');
                    return [2 /*return*/];
            }
        });
    }); });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, chai_1.expect)((0, multicall2_1.multicall2)(mockProvider, multicallContract.address, blockNumber, [call])).to.be.eventually.rejected];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('Does not fail when doing multiple calls at once', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    erc20Interface = new abi_1.Interface(constants_1.ERC20Mock.abi);
                    calls = [
                        {
                            address: tokenContract.address,
                ...
                case 1:
                    blockNumber = _d.sent();
                    return [4 /*yield*/, (0, multicall2_1.multicall2)(mockProvider, multicallContract.address, blockNumber, calls)];
                case 2:
                    result = _d.sent();
                    _a = result[calls[0].address][calls[0].data] || {}, value = _a.value, success = _a.success;
                    (0, chai_1.expect)(value).to.equal(bignumber_1.BigNumber.from(10000));
                    (0, chai_1.expect)(success).to.be["true"];
                    ...
                    (0, chai_1.expect)(value).to.equal(bignumber_1.BigNumber.from(0));
                    (0, chai_1.expect)(success).to.be["true"];
                    return [2 /*return*/];
            }
        });
                    ...
                    calls = [
                        ...
                        // invalid one
                        {
                            ...
                            data: erc20Interface.encodeFunctionData('transferFrom', [
                                ...
                                deployer.address,
                                bignumber_1.BigNumber.from(10000),
                            ]),
                            chainId: mockProvider._network.chainId
                        },
                        {
