...
function NetworkProvider(_a) {
    ...
    var _b = (0, config_1.useConfig)(), autoConnect = _b.autoConnect, pollingInterval = _b.pollingInterval;
    ...
    var onDisconnect = (0, react_1.useCallback)(function (error) {
        deactivate();
        reportError(error);
    }, []);
    (0, react_1.useEffect)(function () {
    ...
    var activate = (0, react_1.useCallback)(function (provider) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    wrappedProvider = providers_1.Provider.isProvider(provider) ? provider : new providers_1.Web3Provider(provider);
                    _b.label = 1;
                case 1:
                ...
                case 3:
                    ...
                    onUnsubscribe();
                    clearSubscriptions_1 = (0, helpers_1.subscribeToProviderEvents)(wrappedProvider.provider, update, onDisconnect);
