    ...
    it('default testing config', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    setup = _e.sent();
                    return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () { return (0, src_1.useConfig)(); }, { config: setup.config })];
                case 2:
                ...
                case 3:
                    ...
                    (0, chai_1.expect)((_b = result.current.networks) === null || _b === void 0 ? void 0 : _b.length).to.eq(42);
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, testing_1.renderDAppHook)(function () { return (0, src_1.useConfig)(); }, { config: config })];
                case 2:
                    _a = _e.sent(), result = _a.result, waitForCurrent = _a.waitForCurrent;
                    return [4 /*yield*/, waitForCurrent(function (val) { return val !== undefined; })];
                case 3:
