...
describe('useChainCall', function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, testing_1.renderWeb3Hook)(function () { return (0, useChainCalls_1.useChainCall)((0, helpers_1.encodeCallData)(callData, chainId_1.ChainId.Localhost)); }, {
    ...
    it('multichain calls return correct initial balances', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testMultiChainUseChainCall(token, [deployer.address], chainId_1.ChainId.Localhost, testing_1.MOCK_TOKEN_INITIAL_BALANCE)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, testMultiChainUseChainCall(secondToken, [secondDeployer.address], testing_1.SECOND_TEST_CHAIN_ID, testing_1.SECOND_MOCK_TOKEN_INITIAL_BALANCE)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var testMultiChainUseChainCall = function (contract, args, chainId, endValue) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, result, waitForCurrent;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, testing_1.renderWeb3Hook)(function () {
                        return (0, useChainCalls_1.useChainCall)((0, helpers_1.encodeCallData)({
                            contract: contract,
                            method: 'balanceOf',
                            args: args
                        }, chainId));
